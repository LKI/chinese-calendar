...
holidays = {
    ...
    datetime.date(year=2018, month=1, day=1): Holiday.new_years_day,
    datetime.date(year=2018, month=2, day=15): Holiday.spring_festival,
    datetime.date(year=2018, month=2, day=16): Holiday.spring_festival,
    datetime.date(year=2018, month=2, day=19): Holiday.spring_festival,
    datetime.date(year=2018, month=2, day=20): Holiday.spring_festival,
    datetime.date(year=2018, month=2, day=21): Holiday.spring_festival,
    datetime.date(year=2018, month=4, day=5): Holiday.tomb_sweeping_day,
    ...
    datetime.date(year=2018, month=9, day=24): Holiday.mid_autumn_festival,
    datetime.date(year=2018, month=10, day=1): Holiday.national_day,
    datetime.date(year=2018, month=10, day=2): Holiday.national_day,
    datetime.date(year=2018, month=10, day=3): Holiday.national_day,
    datetime.date(year=2018, month=10, day=4): Holiday.national_day,
    datetime.date(year=2018, month=10, day=5): Holiday.national_day,
}
...
workdays = {
    ...
    datetime.date(year=2018, month=2, day=11): Holiday.spring_festival,
    datetime.date(year=2018, month=2, day=24): Holiday.spring_festival,
    datetime.date(year=2018, month=4, day=8): Holiday.tomb_sweeping_day,
    datetime.date(year=2018, month=4, day=28): Holiday.labour_day,
    datetime.date(year=2018, month=9, day=29): Holiday.national_day,
    datetime.date(year=2018, month=9, day=30): Holiday.national_day,
}
