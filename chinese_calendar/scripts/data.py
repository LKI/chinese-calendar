...
其中，1月25日（星期日、农历除夕）、1月26日（星期一、农历正月初一）、1月27日（星期二、农历正月初二）为法定节假日，1月31日（星期六）照常公休；1月25日（星期日）公休日调至1月28日（星期三），1月24日（星期六）、2月1日（星期日）两个公休日调至1月29日（星期四）、1月30日（星期五）。
...
其中，10月1日（星期四）、10月2日（星期五）、10月3日（星期六）为国庆节法定节假日，10月4日（星期日）照常公休；10月3日（星期六）公休日及中秋节分别调至10月5日（星期一）、10月6日（星期二），9月27日（星期日）、10月10日（星期六）公休日调至10月7日（星期三）、10月8日（星期四）。
...
　　一、元旦：1月1日～3日放假，共3天。其中1月1日为法定假日，将1月1日(星期六)公休日调至1月3日(星期一)，
1月2日(星期日)照常公休。
　　二、春节：2月9日～15日(农历大年初一至初七)放假，共7天。其中，9日、10日、11日为法定假日，
2月12日(星期六)、13日(星期日)照常公休，将2月5日(星期六)、6日(星期日)两个公休日调至2月14日(星期一)、15日(星期二)，
2月5日、6日上班。
　　三、“五一”：5月1日～7日放假，共7天。其中，1日、2日、3日为法定假日，
将4月30日(星期六)、5月1日(星期日)、8日(星期日)三个公休日调至5月4日(星期三)、5日(星期四)、6日(星期五)，
5月7日(星期六)照常公休，4月30日、5月8日上班。
　　四、“十一”：10月1日～7日放假，共7天。其中，1日、2日、3日为法定假日，
将10月1日(星期六)、2日(星期日)两个公休日调至10月4日(星期二)、5日(星期三)，
10月8日(星期六)、9日(星期日)两个公休日调至10月6日(星期四)、7日(星期五)，10月8日、9日上班。
        """
        self.year_at(2005) \
            .nyd().rest(1, 1).to(1, 3) \
    ...
    # 假如之后想要加的话可以参考以下地址：
    # 2005: https://zh.wikisource.org/zh-hans/国务院办公厅关于2005年部分节假日安排的通知
    # 2004: https://zh.wikisource.org/zh-hans/国务院办公厅关于2004年部分节假日安排的通知
